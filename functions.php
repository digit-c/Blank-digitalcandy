...
//temporarily refresh css at all time.
...
function change_my_field_type($type, $field){
  if ( in_array ( $field->id, array(334,335,221,224,227,251,204,359,352,344,343) ) ) { //change 25 and 26 to the ids of the fields to change
...
//send email on UPDATE when user1 changes a bid form from U2
...
function my_login_stylesheet() {
    wp_enqueue_style( 'custom-login', get_template_directory_uri() . '/style-iframe-login.css?v=5' );
}
